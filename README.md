...
tutorial: https://cl.ly/0O3X1G2C1l1f

This application allows a user to input a product ID and quantity amount for a Justin Bieber themed product. The remaining number of units left and total price for the user is then displayed.
